...
Argentina (1), Spain (2), France (3), England (4), Portugal (5), Brazil (6), Morocco (7), Netherlands (8), Belgium (9), Germany (10), Croatia (11), Colombia (13), Mexico (14), Senegal (15), Uruguay (16), USA (17), Japan (18), Switzerland (19), IR Iran (20), Türkiye (22), Ecuador (23), Austria (24), Korea Republic (25), Australia (27), Algeria (28), Egypt (29), Canada (30), Norway (31), Côte d'Ivoire (33), Panama (34), Sweden (38), Scotland (40), Czechia (41), Paraguay (42), Tunisia (45), Congo DR (46), Uzbekistan (50), Qatar (56), Iraq (57), South Africa (60), Saudi Arabia (61), Jordan (63), Bosnia and Herzegovina (64), Cabo Verde (67), Ghana (73), Curacao (82), Haiti (83), New Zealand (85).

## Resolved data issues
- **Rank-7 tie resolved**: Morocco (1756.94 pts) stays rank 7; Netherlands (1753.57
  pts) moved to rank 8. Tie-break by FIFA points sourced from the official 2026-06-11
  table (whereig.com/football/fifa-world-rankings.html cross-referenced with ESPN).
- **`fifa_points` backfilled**: all 22 previously-null teams now carry 2026-06-11
  FIFA points sourced from the official ranking table. Zero nulls remain. The
  deterministic model now uses the more precise points-based supremacy calculation
  for every matchup instead of falling back to ranking position.
